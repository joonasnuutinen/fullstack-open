...
describe('favorite blog', () => {
  ...
  test('of many blogs is returned right', () => {
    const fav = { _id: '5a422b3a1b54a676234d17f9', title: 'Canonical string reduction', author: 'Edsger W. Dijkstra', url: 'http://www.cs.utexas.edu/~EWD/transcriptions/EWD08xx/EWD808.html', likes: 12, __v: 0 }
...
describe('most likes', () => {
  ...
  test('of one blog returns its author and likes', () => {
    expect(mostLikes(oneBlog)).toEqual({ author: 'Edsger W. Dijkstra', likes: 5 })
  })
